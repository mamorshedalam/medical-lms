...
function EditCardSlide({ open, setOpen, setCards, selectedCard, setIsRendering }) {
                        ...
                        <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                            ...
                            >
                                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                                    <div className="flex h-full flex-col overflow-y-scroll bg-white text-black py-6 shadow-xl">
                                                ...
                                                >
                                                    ...
                                                    <div className="relative mt-2">
                                                        <Combobox.Input
                                                            ...
                                                            className="w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-12 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-violet-600 sm:text-sm sm:leading-6"
                                        ...
                                        <div className="mt-4 flex flex-row-reverse sm:px-6">
                                            ...
                                            >
                                                {isUploading && <Spinner size="sm" />}Update Card
                                            </button>
                                        </div>
                                    </div>
                                </Dialog.Panel>
