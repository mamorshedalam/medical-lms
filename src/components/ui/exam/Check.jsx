...
function Check({ checked, styleFill }) {
    if (checked)
        return (
            <div className={`rounded my-1 w-4 h-4 border-2 border-primary-700 ${styleFill ? 'bg-primary' : 'bg-white'} text-primary-600 flex justify-center items-center font-bold`}>
