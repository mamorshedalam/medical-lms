...
const Label = ({ children, colorInherit, color, onClick }) => {
    ...
    return (
        ...
        px-3 min-w-fit relative rounded-full border-2 max-w-fit flex items-center gap-2 ${onClick && "hover:cursor-pointer"
                }`}
        >
            {children}
        </div>
