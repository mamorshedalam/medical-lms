...
const EditNewItemModal = ({currentItem, openModal, setOpenModal }) => {
    ...
    const [selectedMatiere, setSelectedMatiere] = useState(
        libraryState.materialsAtom.find((matiere) => matiere._id === currentItem?.matiere_id)
    );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await authHttpClient.put(`/item/${currentItem._id}`, updatedData);
            Toaster(ToastType.SUCCESS, "Items updated successfully!");
...
export default EditNewItemModal;
