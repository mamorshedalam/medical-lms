...
const EditMatiereModal = ({ currentData, openModal, setOpenModal }) => {
    ...
    useEffect(() => {
        ...
        setImageBuffer(currentData?.image ?? "");
    }, [currentData]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response) {
                Toaster(ToastType.SUCCESS, "Matiere updated successfully!");
    ...
    return (
        <Modal title="Edit Matiere" size="sm" open={openModal} setOpen={setOpenModal}>
            <div className="">
                <Input
                    name="matiere"
                    label="Matiere Name"
                ...
                <div className="mt-4 flex flex-row-reverse">
                    ...
                    >
                        ...
                        {
                            isUploading ? <span>Submitting</span> : <span>Update Matiere</span>
                        }
                    </button>
                </div>
            </div>
