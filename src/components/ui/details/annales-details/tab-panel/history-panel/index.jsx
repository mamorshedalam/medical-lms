...
const AnnalesHistoryPanel = ({ name }) => {
  ...
  return (
    <div className="py-1.5">
      <Card  className="mt-5 pb-2">
        ...
        <DataTable
          columns={annalesHistoryColumns}
          data={annalesHistoryData}
          customStyles={annalesHistoryCustomStyles}
          pagination
...
export default AnnalesHistoryPanel;
