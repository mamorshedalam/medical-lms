...
import {
  itemOptions,
  annalesHistoryData,
  annalesHistoryCustomStyles,
  annalesHistoryColumns,
  questionTypes,
  sessionTypes,
  playlistsHistoryColumns,
  playlistData,
  playlistsHistoryCustomStyles,
  playlistsHistoryData,
} from "@/constants/mockup-data/library";
import Segmented from "@/components/ui/Segmented";
import Dropdown from "@/components/ui/dropdown";
import DropdownSingleSelect from "@/components/ui/dropdown-single-select";

const SavedQuestionsPanel = () => {
    ...
    <div className="py-1.5">
      <Card  className="mt-5 pb-2">
        <div className="flex justify-between items-center px-7 py-6 border-b border-[#EAECF0]">
          <h2 className="font-manrope font-bold text-2xl">All history</h2>
        ...
        <DataTable
          columns={playlistsHistoryColumns}
          data={playlistsHistoryData}
          customStyles={playlistsHistoryCustomStyles}
          pagination
...
export default SavedQuestionsPanel;
