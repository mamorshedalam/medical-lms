...
const SidebarActionBtn = ({ text, click, icon }) => {
  ...
  return (
    <a
      onClick={() => click()}
      className="group flex items-center space-x-[10px] max-md:border-2 max-md:p-2 max-md:border-white max-md:border-opacity-[0.48] rounded-[13.6px] md:rounded-[5px] max-md:bg-white max-md:bg-opacity-10 md:p-3 md:hover:bg-custom-border md:hover:bg-opacity-5 transition-all cursor-pointer"
    >
