import QuickAccess from "@/components/ui/dashboard/QuickAccess";
import RecentItem from "@/components/ui/dashboard/RecentItem";
import TrandingItem from "@/components/ui/dashboard/TrandingItem";
...
export default function Home() {
  ...
  const userRoles = oauthUser && oauthUser["http://azrdxop.eu.auth0.com/roles"];
      ...
      <div className="grid sm:grid-cols-2 gap-8">
        <div className="rounded-lg bg-gray-100 min-h-80 p-8 grid lg:grid-cols-2 click-action hover:cursor-pointer shadow-lg hover:shadow-primary-300">
          <div className="lg:-mr-10">
            ...
            <div className="p-2 font-bold text-3xl text-black">
              Journée mondiale <br />
              de la Tuberculose
            </div>
        ...
        <div className="rounded-lg bg-gray-100 min-h-80 p-8 click-action hover:cursor-pointer shadow-lg hover:shadow-primary-300">
          ...
          <div className="p-2 font-bold text-3xl text-black">Méthotrexate</div>
          <div className="px-2 text-gray-400">
