...
export default function ExamPage() {
    ...
    const { questions, setQuestions, dps, setDps, submitAnswers, isSubmitting, setResumeSession } = useExam()
    const [dpOrQuestion, setDpOrQuestion] = useState("dp")
            ...
            <div className="flex flex-col h-[100vh-100px]">
                <div className="relative flex-1">
                    ...
                    <div className={`${sidebarLeft ? "lg:pl-72" : "lg:pr-72"} h-[calc(100vh-100px)] overflow-auto`}>
                        ...
                        {dpOrQuestion === "question" && questions?.length > 0 && (
                            <QuestionCardSimple
