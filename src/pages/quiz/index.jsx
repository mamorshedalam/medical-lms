...
import Sidebar from "@/components/ui/exam/Sidebar";
import QuestionCard from "@/components/ui/exam/QuestionCard";
        ...
        <div className="lg:pr-72">
          ...
          <div className="fixed bottom-[20px] right-72 m-4">
            <div className="with-tooltip relative flex items-center justify-center">
              <button
                className=" w-[3rem] h-[3rem] bg-primary text-white transition duration-300 rounded-full"
                onClick={saveQuiz}
              >
                <svg
