  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        "gradient-progressbar-thumb-gray":
          "linear-gradient(180deg, #C6C6C6 0%, #57585C 100%)",
        "gradient-dark":
          "linear-gradient(180deg, #8E8E8E 0%, #777777 25%, #1E1E1E 100%)",
        "gradient-purple":
          "linear-gradient(180deg, #9890FD 0%, #7267F2 25%, #6159BB 100%)",
      },
      boxShadow: {
        "dark-purple": "0 2px 0 0 #4940AE",
        "dark-gray": "0 2px 0 0 #00000022",
        "light-gray": "0 0 4px 0 #00000055",
        gray: "1px 2px 4px 0 #00000016",
        card: "0 8px 20px 0 #00000011",
        inside: "inset 0 2px 4px 0px #0000000d",
        inside2: "inset 0 4px 12px 0px #00000010",
        "rank-mark": "0 2px 2px 0 #00000040",
      },
      colors: {
        primary: "#6255E5",
        "custom-dark-purple": "#4940AE",
        "custom-light-gray": "#FAFAFA",
        "custom-semi-light-gray": "#F3F3F4",
        "custom-dark": "#151A1E",
        "custom-gray": "#667085",
      ...
      animation: {
        rebound: "rebound 0.5s ease-in-out",
      },
      screens: {
        xs: "480px",
        sm: "768px",
